...
uint256 hashGenesisBlock("0x000000dcb4434e2148558a0a5c71e5c06d864accef97d75ac1c031405deb3371");
...
const string strMessageMagic = "BlakeBitcoin Signed Message:\n";
                              ...
                              enum GetMinFee_mode mode) const
{
    ...
    if (fAllowFree)
    {
        if (nBlockSize == 1)
        {
            ...
            // (about 4500 B if made of 50 B inputs)
            if (nBytes < 10000)
                nMinFee = 0;
        }
        else
...
*/
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x0423141660220f9f155a4129a49dcb6431bbed9cd037bba3da34c2baa53ed0ac"));
...
unsigned char pchMessageStart[4] = { 0xf9, 0xbc, 0xa7, 0xb7 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BlakeBitcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BlakeBitcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BlakeBitcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("blakebitcoin-miner");
    ...
    try { loop {
        ...
        printf("Running BlakeBitcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BlakeBitcoinMiner terminated\n");
        throw;
    }
}
